...
class FireRecognitionDataset:
    def __init__(self):
        ...
        self.data = datasets.ImageFolder(
            "./fire_dataset/train/", transform=transform_train
        )

        self.data_test = datasets.ImageFolder(
            "./fire_dataset/test/", transform=transform_test
        )
        ...
        # classes
        root = pathlib.Path("./fire_dataset/train/")
